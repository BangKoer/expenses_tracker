...
import 'package:expenses_tracker/function/dateTime_conv.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class ExpenseSummary extends StatelessWidget {
  final DateTime startOfWeek;
  const ExpenseSummary({required this.startOfWeek});
  ...
  double calculateMax(
    ...
    // get largest amount (end of the sorted list)
    // and increase the cap slightly so the graph look almost full
    max = values.last + 1.1;
